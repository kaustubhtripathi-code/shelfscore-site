...
Changes to `master`, CI branches and pull requests run the project checks. Use **Actions → CI and delivery → Run workflow** for a manual repeat. Any failed step blocks delivery in this workflow.
